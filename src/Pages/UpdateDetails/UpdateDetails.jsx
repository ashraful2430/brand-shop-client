...
const UpdateDetails = () => {
    ...
    const { brandName, description, photo, price, productName, rating, type, _id } = updateProduct;
        ...
        fetch(` https://my-tenth-assignment-server-jzdbdk0k0.vercel.app/brands/${_id}`, {
            ...
            .then(data => {
                ...
                if (data.modifiedCount) {
                    swal("Well Done!", "Product updated successfully!", "success");
            ...
            <section className="bg-white pt-24 pb-8 md:max-w-screen-xl mx-auto">
                ...
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    ...
                    >
                        <img
                            alt="Night"
                            src="https://i.ibb.co/T0jB9K7/pexels-karolina-grabowska-5625010.jpg"
                        ...
                        <div className="hidden lg:relative lg:block lg:p-12">
                            ...
                            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                                Welcome to Techno trend  🖥️
                            </h2>

                            <p className="mt-4 leading-relaxed text-white/90">
                                Welcome to our Techno trend store . Here you will find the best and finest Computer and phones for you and your family in your budget!!
                            </p>
                        </div>
                    </section>
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl">
                            ...
                            <form onSubmit={updateSubmit} className="mt-8 grid grid-cols-6 gap-6  w-full">
                                ...
                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4  border">
                                    <button
                                        type="submit"
                                        className="inline-block shrink-0 rounded-md border w-full border-pink-600 bg-pink-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-black focus:outline-none focus:ring active:text-pink-500"
                                    >
                                        Update Product
                                    </button>
